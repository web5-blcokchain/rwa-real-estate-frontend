  ...
  return (
    <div className="md:px-8">
      ...
      <div className="mt-32 bg-[#242933] px-8 py-14">
        ...
        <div className="mt-16 flex flex-col gap-12 lt-md:items-start md:items-center md:gap-8">
          {
      ...
      <div className="mt-32 px-8 py-14">
        ...
        <div className="grid grid-cols-1 mt-16 gap-8 md:grid-cols-4">
          <div className="mx-a w-full rounded-xl bg-[#242933] py-6 text-center lt-md:w-64 space-y-4">
